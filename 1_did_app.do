...
** Data File : Distribution_Inequality.dta 
...
**Import the data
use "Distribution_Inequality.dta", clear
...
twoway(histogram ratio if treat == 1 & post == 0, color(stc1%70))(histogram ratio if treat == 0 & post == 0, color(stc2%70)), legend(order(1 "Treatment" 2 "Control")) xlabel(, nogrid) ylabel(, nogrid)
...
twoway(histogram ratio if treat == 1 & post == 0 & ratio <= 10 & ratio >= 0, color(stc1%70))(histogram ratio if treat == 0 & post == 0 & ratio <= 10 & ratio >= 0, color(stc2%70)), legend(order(1 "Treatment" 2 "Control")) xlabel(, nogrid) ylabel(, nogrid)
...
twoway(line ratio_mean post if treat == 1, color(stc1))(line ratio_mean post if treat == 0, color(stc2))(scatter ratio_mean post if treat == 1, color(stc1) msize(large))(scatter ratio_mean post if treat == 0, color(stc2) msize(large) msymbol(triangle)), xline(0.5) legend(order(3 "Treatment" 4 "Control")) xtitle("POST") ytitle("Shareholder-Worker Ratio") xlabel(#2, nogrid) ylabel(, nogrid)
...
twoway(line ratio_mean post if treat == 1, color(stc1))(line ratio_mean_plus_prediff post if treat == 0, color(stc2))(scatter ratio_mean post if treat == 1, color(stc1) msize(large))(scatter ratio_mean_plus_prediff post if treat == 0, color(stc2) msize(large) msymbol(triangle)), xline(0.5) legend(order(3 "Treatment" 4 "Control")) xtitle("POST") ytitle("Shareholder-Worker Ratio") xlabel(#2, nogrid) ylabel(, nogrid)
...
twoway(line ratio_mean_year year if treat == 1 & year <= 2014, color(black))(line ratio_mean_year year if treat == 0 & year <= 2014, color(black) lp(dash))(line ratio_mean_year year if treat == 1 & year >= 2016, color(black))(line ratio_mean_year year if treat == 0 & year >= 2016, color(black) lp(dash))(scatter ratio_mean_year year if treat == 1 & year <= 2014, color(stc1) msymbol(circle) msize(large))(scatter ratio_mean_year year if treat == 0 & year <= 2014, color(stc2) msymbol(triangle) msize(large))(scatter ratio_mean_year year if treat == 1 & year >= 2016, color(stc1) msymbol(circle) msize(large))(scatter ratio_mean_year year if treat == 0 & year >= 2016, color(stc2) msymbol(triangle) msize(large)), xline(2015) xtitle("Year") ytitle("Shareholder-Worker Ratio") xlabel(, nogrid) ylabel(, nogrid) legend(order(5 "Treatment" 8 "Control")) 
...
twoway(rspike citop cibottom time, lwidth(vvvthick) mcolor(gray%0) lcolor(gray%25) fcolor(gray%0))(sc b time, color(stc2) msize(large) msymbol(diamond)), xtitle("Placebo Year") xline(-1) yline(0, lcolor(black)) ytitle("Estimated Effects") legend(order(4)) xlabel(1 "2011" 2 "2012" 3 "2013" 4 "2014", nogrid) ylabel(, nogrid) title("Placebo Tests")
...
twoway(rspike citop cibottom time, lwidth(vvvthick) mcolor(gray%0) lcolor(gray%25) fcolor(gray%0))(sc coef time, color(stc2) msize(large) msymbol(diamond)), xtitle("Event Time") xline(5) yline(0, lcolor(black)) ytitle("Estimated Effects") legend(order(4)) xlabel(1 "-5" 2 "-4" 3 "-3" 4 "-2" 5 "-1" 6 "0" 7 "1" 8 "2" 9 "3" 10 "4", nogrid) ylabel(, nogrid) title("Event Study Plot")

/*Event study plot with different baselines
forvalues k = 1(1)4{
...
twoway(rspike citop cibottom time, lwidth(vvvthick) mcolor(gray%0) lcolor(gray%25) fcolor(gray%0))(sc coef time, color(stc2) msize(large) msymbol(diamond)), xtitle("Event Time") xline(`k') yline(0, lcolor(black)) ytitle("Estimated Effects") legend(order(4)) xlabel(1 "-5" 2 "-4" 3 "-3" 4 "-2" 5 "-1" 6 "0" 7 "1" 8 "2" 9 "3" 10 "4", nogrid) ylabel(, nogrid) title("Event Study Plot") name(e`k', replace)
}
...
twoway(histogram inst if treat == 1 & post == 0, color(stc1%70))(histogram inst if treat == 0 & post == 0, color(stc2%70)), legend(order(1 "Treatment" 2 "Control")) xlabel(, nogrid) ylabel(, nogrid) title("INST")

**Create a histogram of roe for the treatment group and the control group in the pre-treatment period
twoway(histogram roe if treat == 1 & post == 0, color(stc1%70))(histogram roe if treat == 0 & post == 0, color(stc2%70)), legend(order(1 "Treatment" 2 "Control")) xlabel(, nogrid) ylabel(, nogrid) title("ROE")
...
twoway(rspike citop cibottom time, lwidth(vvvthick) mcolor(gray%0) lcolor(gray%25) fcolor(gray%0))(sc coef time, color(stc2) msize(large) msymbol(diamond)), xtitle("Event Time") xline(5) yline(0, lcolor(black)) ytitle("Estimated Effects") legend(order(4)) xlabel(1 "-5" 2 "-4" 3 "-3" 4 "-2" 5 "-1" 6 "0" 7 "1" 8 "2" 9 "3" 10 "4", nogrid) ylabel(, nogrid) title("Controlling for Confounding Events")
*/

***Testing no spillover assumption
**Import the data
use "DID_Application.dta", clear
...
twoway(rspike citop cibottom time, lwidth(vvvthick) mcolor(gray%0) lcolor(gray%25) fcolor(gray%0))(sc coef time, color(stc2) msize(large) msymbol(diamond)), xtitle("Event Time") xline(5) yline(0, lcolor(black)) ytitle("Estimated Effects") legend(order(4)) xlabel(1 "-5" 2 "-4" 3 "-3" 4 "-2" 5 "-1" 6 "0" 7 "1" 8 "2" 9 "3" 10 "4", nogrid) ylabel(, nogrid) title("Testing No Spillover Assumption")
*/
